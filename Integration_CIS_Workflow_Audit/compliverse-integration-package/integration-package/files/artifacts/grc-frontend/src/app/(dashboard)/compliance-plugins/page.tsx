          ...
          <button
            ...
            title={
              !canScan && !permsLoading
                ...
                ? 'Connect at least one asset first via Administration → Integrations'
            ...
            <div>
              {selectedIds.size > 0 ? (
                <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-1.5 text-sm">
                  ...
                  <button
                    onClick={() => bulkReviewM.mutate({ ids: Array.from(selectedIds), decision: 'approve' })}
                  ...
                  <button
                    onClick={() => bulkReviewM.mutate({ ids: Array.from(selectedIds), decision: 'reject' })}
                    disabled={bulkReviewM.isPending}
