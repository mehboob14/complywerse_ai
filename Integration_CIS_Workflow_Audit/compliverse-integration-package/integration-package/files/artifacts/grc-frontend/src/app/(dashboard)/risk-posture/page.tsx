    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          ...
          className="px-3 py-2 text-sm rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 whitespace-nowrap flex-shrink-0"
          title="Customise how each dimension contributes to the composite score"
        >
          ⚙ Tune weights
        </button>
      </div>
