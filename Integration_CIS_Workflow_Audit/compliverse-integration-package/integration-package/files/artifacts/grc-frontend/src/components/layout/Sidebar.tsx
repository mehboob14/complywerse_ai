...
const navigation: NavEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Plugin Automation', href: '/compliance/plugins', icon: Bot, requiredPermissions: ['compliance:frameworks:*'] },
      ...
      { name: 'Bulk Discovery', href: '/admin/discover', icon: Bot, requiredPermissions: ['compliance:frameworks:*'] },
