        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          <div className="flex-1 overflow-y-auto px-5 py-4">
            ...
            <div className="border-t border-slate-200 pt-3 mt-1">
              ...
              {/* Row: Operating system — drives the strict matcher.
                  Entering os_version triggers backend AI auto-classify
                  (see Gap A). os_normalized is an optional operator
                  override for when AI gets it wrong. Leave both blank
                  for non-OS-bearing assets (e.g. a Vendor record). */}
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-900 focus:border-blue-500 focus:outline-none"
                      placeholder='e.g., "Microsoft Windows 11 Pro 25H2", "Ubuntu 22.04 LTS"'
                    />
                    <p className="mt-0.5 text-[10px] text-slate-500">
                      Any free-form OS string. AI normaliser converts it
                      to a canonical key.
                    </p>
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-slate-600 mb-0.5">
                      Normalized key (optional override)
                    </label>
                    <input
                      type="text"
                      value={formData.os_normalized}
                      onChange={(e) =>
                        setFormData({ ...formData, os_normalized: e.target.value })
                      }
                    ...
                    />
                    <p className="mt-0.5 text-[10px] text-slate-500">
                      Leave blank to let AI classify automatically.
                    </p>
                  </div>
                </div>
              </div>
