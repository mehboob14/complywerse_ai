...
import { KPI_FORMAT, GOOD, BAD, TEAL, type Kpi, type LiveMetric, buildKpis, pct, toneOf, RichTrend, KpiDetailModal } from '@/cyber-assurance/components/dashboard/kpiShared';
