...
import { scoreBand, ScoreRing, SectionDetailModal, type OverviewSection } from '@/cyber-assurance/components/dashboard/score-kit';
import ScoreBreakdownCard, { scoreCardRow } from '@/cyber-assurance/components/dashboard/ScoreBreakdownCard';
