...
import { scoreBand, ScoreRing } from '@/cyber-assurance/components/dashboard/score-kit';
import {
...
const MODULES: ModuleDef[] = [
  ...
  {
    key: 'assets', label: 'Assets', href: '/cyber-assurance/assets', Icon: Server, viz: 'radar',
