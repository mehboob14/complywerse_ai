...
export default function AlignmentPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-1 rounded-xl bg-slate-800 p-1">
        {tabs.map((tab) => (
          <button
            key={tab.key}
        ...
        {alignmentsLoading ? (
          ...
          <div className="divide-y divide-slate-700">
            {filteredAlignments.map((alignment) => {
              ...
              return (
                <div key={alignment.id} className="p-4 hover:bg-slate-700/50">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="flex-1 space-y-3">
                      ...
                      <div>
                        ...
                        {parsed?.domain && (
                          <span className="mt-1 inline-block rounded-full bg-slate-600 px-2 py-0.5 text-xs text-slate-300">
                            {parsed.domain}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 rounded-lg bg-slate-700 px-3 py-1.5 text-sm font-medium text-slate-300 transition-colors hover:bg-slate-600 hover:text-white"
                      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl border border-slate-700 bg-slate-800">
            <div className="flex items-center justify-between border-b border-slate-700 p-4">
              <h3 className="text-lg font-semibold text-white">Confirm Alignment</h3>
              <button
            ...
            <div className="p-4 space-y-4">
              <div className="rounded-lg bg-slate-900/50 p-3">
                ...
                <p className="font-mono text-sm text-white">{confirmModal.parsed_control?.control_id}</p>
                <p className="text-sm text-slate-300">{confirmModal.parsed_control?.title}</p>
              </div>
      ...
      {editModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl border border-slate-700 bg-slate-800">
            <div className="flex items-center justify-between border-b border-slate-700 p-4">
              <h3 className="text-lg font-semibold text-white">Edit Alignment</h3>
              <button
            ...
            <div className="p-4 space-y-4">
              <div className="rounded-lg bg-slate-900/50 p-3">
                <p className="text-xs text-slate-400 mb-1">Parsed Control</p>
                <p className="font-mono text-sm text-white">{editModal.parsed_control?.control_id}</p>
                <p className="text-sm text-slate-300">{editModal.parsed_control?.title}</p>
              </div>
