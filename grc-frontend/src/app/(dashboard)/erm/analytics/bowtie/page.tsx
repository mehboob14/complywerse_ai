      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none rounded-lg border border-slate-300 bg-slate-100 px-4 py-3 pr-10 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      {selectedRiskId && bowTieData && !bowTieLoading && (
        <>
          <div className="rounded-xl border border-slate-200 bg-white p-6 overflow-x-auto">
            <div className="flex items-stretch justify-center gap-2 min-w-[900px]">
              ...
              <div className="flex flex-col justify-center flex-shrink-0 w-[220px]">
                <div className="rounded-xl border-2 border-amber-500 bg-gradient-to-br from-amber-500/20 to-orange-500/10 p-5 text-center shadow-lg shadow-amber-500/10">
                  ...
                  <h3 className="text-lg font-bold text-slate-900">{bowTieData.risk_title}</h3>
            ...
            <div className="mt-6 flex items-center justify-center gap-8 border-t border-slate-200 pt-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Risk Details</h3>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Score Analysis</h3>
              <div className="grid grid-cols-3 gap-4">
                <div className="rounded-lg bg-slate-100/50 p-4 text-center">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2 text-sm font-medium text-slate-900 shadow-lg shadow-purple-500/25 hover:from-purple-500 hover:to-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
