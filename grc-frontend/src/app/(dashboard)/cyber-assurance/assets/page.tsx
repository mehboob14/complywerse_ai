...
import { CriticalityCoverageWidget } from '@/cyber-assurance/components/assets/CriticalityCoverageWidget';
import { ITAsset } from '@/cyber-assurance/types';
...
export default function AssetsPage() {
  ...
  const handleView = (e: React.MouseEvent, id: number) => {
    e.stopPropagation();
    router.push(`/cyber-assurance/assets/${id}`);
  };
  ...
  const handleConnect = (e: React.MouseEvent, asset: ITAsset) => {
    ...
    router.push(`/cyber-assurance/admin/integrations/connect?${params.toString()}`);
  };
