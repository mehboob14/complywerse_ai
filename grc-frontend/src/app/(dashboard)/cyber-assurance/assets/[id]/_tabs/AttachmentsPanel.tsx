...
const BTN_PRIMARY =
  'inline-flex items-center gap-1.5 h-[33px] px-3.5 rounded-[10px] border border-[#005B96] bg-[#005B96] ' +
  'text-[#06342B] text-[12px] font-semibold hover:bg-[#014A81] disabled:opacity-50 transition-colors whitespace-nowrap';
    ...
    <div className="text-[13.5px] text-[#0F1F2B]">
      <div className={CARD}>
        ...
        <div className="flex items-center gap-[9px] px-4 py-[13px] border-b border-[#F0F3F5]">
          <FileCheck className="h-[18px] w-[18px] text-[#014A81] shrink-0" />
        ...
        <div className="px-4 pt-3 pb-4">
          ...
          {hasLinked ? (
            ...
            <div className="mt-3 flex flex-col items-center text-center border-[1.5px] border-dashed border-[#E8ECEE] rounded-[11px] bg-[#FAFBFC] px-5 py-[26px]">
              <span className="w-[46px] h-[46px] rounded-[13px] bg-[#EFF5FA] text-[#014A81] flex items-center justify-center">
