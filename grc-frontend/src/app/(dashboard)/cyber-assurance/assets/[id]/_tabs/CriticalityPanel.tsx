...
import { criticalityApi, type IscaItem, type IacaItem } from '@/cyber-assurance/lib/api';
import { GuideMarker } from '@/cyber-assurance/components/guide';
import { PageLoader } from '@/cyber-assurance/components/ui';
...
const CHIP = 'inline-flex items-center gap-1.5 text-[11.5px] font-semibold px-2.5 py-1 rounded-lg whitespace-nowrap border text-[#014A81] bg-[#EFF5FA] border-[#BFEBE0] hover:bg-[#D8F2E9]';
      ...
      <tr key={`${kind}-${item.id}`} className="hover:bg-[#F9FAFA]">
        ...
        <td className={TD + ' text-right'}>
          <Link
            ...
            className="text-[12px] font-semibold text-[#014A81] hover:underline whitespace-nowrap"
          >
            Open →
          </Link>
        </td>
        ...
        <div className={CARD + ' px-6 py-10 text-center'}>
          ...
          <div className="mt-5 inline-flex flex-wrap items-center justify-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold px-3.5 py-2 rounded-[9px] whitespace-nowrap border bg-[#005B96] text-[#06342B] border-[#005B96] hover:bg-[#014A81]"
            >
              + New Information System assessment
            </Link>
            <Link
              href={`/cyber-assurance/assets/criticality-assessments?create=iaca&asset=${assetId}`}
              className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold px-3.5 py-2 rounded-[9px] whitespace-nowrap border bg-white text-[#014A81] border-[#BFEBE0] hover:bg-[#F9FAFA]"
            >
        ...
        <>
          ...
          <div className={CARD}>
            <div className="flex items-center justify-between gap-3 px-[18px] py-3.5 border-b border-[#F0F3F5] flex-wrap">
              ...
              <Link href="/cyber-assurance/assets/criticality-assessments" className={BTN_SECONDARY}>
                Manage assessments
              </Link>
            </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Link href={`/cyber-assurance/assets/criticality-assessments?create=isca&asset=${assetId}`} className={CHIP}>
              + New ISCA
            </Link>
            <Link href={`/cyber-assurance/assets/criticality-assessments?create=iaca&asset=${assetId}`} className={CHIP}>
              + New IACA
            </Link>
