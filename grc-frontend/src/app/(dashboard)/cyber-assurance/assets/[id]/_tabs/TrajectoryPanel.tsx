 ...
 * tokens (--ac-soft #EFF5FA / --ac-strong #014A81, white card, #E8ECEE border/15px
        ...
        <div className="flex items-start justify-between gap-3 px-4 py-[13px]">
          <div className="min-w-0">
            <h2 className="flex items-center gap-2 text-[12.5px] font-semibold tracking-[-.01em] text-[#0F1F2B]">
              <span className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-lg bg-[#EFF5FA] text-[#014A81]">
