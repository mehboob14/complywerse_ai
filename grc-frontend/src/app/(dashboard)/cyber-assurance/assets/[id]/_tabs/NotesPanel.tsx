 ...
 * '@/cyber-assurance/components/shared/EntityExtras'. Same data contract — the
      ...
      <div style={{ padding: '15px 16px', borderBottom: `1px solid ${BORDER2}`, display: 'flex', gap: 10 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <textarea
            ...
            className="border border-[#E8ECEE] bg-[#F7F9FA] focus:outline-none focus:border-[#005B96] focus:bg-white transition-colors"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 9, flexWrap: 'wrap' }}>
            ...
            <button
              ...
              className="bg-[#005B96] hover:enabled:bg-[#014A81] transition-colors"
