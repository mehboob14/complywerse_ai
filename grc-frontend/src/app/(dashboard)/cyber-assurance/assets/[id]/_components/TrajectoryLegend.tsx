      ...
      <div className="space-y-2.5 text-[11px]">
        ...
        <section>
          ...
          <ul className="space-y-1 text-slate-700">
            ...
            <li className="flex items-center gap-2"><svg width="20" height="6"><line x1="0" y1="3" x2="20" y2="3" stroke="#3279A3" strokeWidth="1.8" strokeDasharray="5 3" /></svg>Mitigation unknown</li>
