...
const bandTone = (score: number) =>
  ...
  : { fg: '#014A81', bg: '#EFF5FA', label: 'contained' };
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5">
      <div className="mb-4 flex items-center gap-2">
        ...
        <Link href={`/cyber-assurance/risk-posture/asset/${assetId}`} className="ml-auto flex items-center gap-1 text-[12.5px] font-semibold text-teal-700 hover:underline">
