...
import { integrationsApi } from '@/cyber-assurance/lib/api';
import {
  BarChart3,
  Loader2,
  Shield,
...
import { IdentityProvidersCard } from '@/cyber-assurance/components/integrations/IdentityProvidersCard';
import { IntegrationPlatformsCard } from '@/cyber-assurance/components/integrations/IntegrationPlatformsCard';
import {
  BarChart,
  Bar,
  XAxis,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/cyber-assurance/assets" className="text-xs text-primary-600 hover:underline flex items-center gap-1">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/cyber-assurance/integrations/connections" className="text-xs text-primary-600 hover:underline flex items-center gap-1">
          ...
          <div className="space-y-3">
            ...
            {(connections as any[]).length === 0 && (
              <div className="text-center py-8 text-slate-400 text-sm">
                ...
                <Link href="/cyber-assurance/integrations/connections" className="text-primary-600 hover:underline">Add one</Link>
              </div>
            )}
          </div>
        </div>
