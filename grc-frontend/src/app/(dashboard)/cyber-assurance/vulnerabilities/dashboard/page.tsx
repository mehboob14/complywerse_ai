...
import { Abbr } from '@/cyber-assurance/components/common/Abbr';
import {
  Loader2,
  RefreshCw,
  Shield,
                  ...
                  {data.top_priority_vulns.map((v, i) => (
                    <tr key={v.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-1.5 pr-2">
                        <a href={`/cyber-assurance/vulnerabilities/${v.id}`} className="text-blue-600 hover:underline truncate inline-block max-w-[160px]" title={v.title}>
                          {v.title}
                        </a>
                        {v.kev_flag && (
          ...
          <div className="rounded-lg border border-gray-100 p-2">
            ...
            <ResponsiveContainer width="100%" height={220}>
              ...
              >
                ...
                <YAxis tick={{ fontSize: 10 }} allowDecimals={false} />
                <Tooltip />
                <Line type="monotone" dataKey="count" stroke="#3279A3" strokeWidth={2} dot={false} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
