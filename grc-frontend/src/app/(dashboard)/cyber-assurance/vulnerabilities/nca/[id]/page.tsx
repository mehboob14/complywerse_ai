...
import apiClient, { assetsApi, controlsApi } from '@/cyber-assurance/lib/api';
import {
...
export default function NcaVulnDetailPage() {
  ...
  return (
    <div className="space-y-4 px-3 sm:px-6 max-w-7xl mx-auto pb-12">
      <button
        onClick={() => router.push('/cyber-assurance/vulnerabilities?view=nca')}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button onClick={() => router.push('/cyber-assurance/vulnerabilities?view=nca&edit=' + entry.id)}
