    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <Link href="/cyber-assurance/vulnerabilities" className="text-xs text-slate-500 hover:text-slate-800">
            ← Register
          </Link>
          {canEdit && (
            <button
            ...
            <div key={e.vulnerability_id}>
              ...
              >
                ...
                <span className="flex-1 min-w-0">
                  <Link
                    href={`/cyber-assurance/vulnerabilities/${e.vulnerability_id}`}
