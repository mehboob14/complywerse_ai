      ...
      <div className="min-h-screen bg-slate-50">
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-8 text-center">
            ...
            <button onClick={() => router.push('/cyber-assurance/asset-discovery')} className="px-4 py-2 bg-primary-600 text-[color:var(--color-on-base,#0a0a0a)] text-sm rounded-md hover:bg-primary-700">
              ← Back to dashboard
            </button>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-xl shadow-md border-2 border-emerald-200 p-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button onClick={() => router.push('/cyber-assurance/assets')} className="px-5 py-2 bg-primary-600 text-[color:var(--color-on-base,#0a0a0a)] rounded-lg text-sm font-medium hover:bg-primary-700">
                View IT Assets →
              </button>
              <button onClick={() => router.push('/cyber-assurance/risk-posture')} className="px-5 py-2 bg-slate-100 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-200">
                Risk Posture
              </button>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-xs text-primary-800">
                ...
                so you can delete them afterwards from <a href="/cyber-assurance/assets" className="underline">/assets</a> if needed.
              </p>
              <button
                type="button"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="CN=svc-ava,OU=Service Accounts,DC=bank,DC=local"
                  required
                  className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm font-mono"
                />
              </div>
