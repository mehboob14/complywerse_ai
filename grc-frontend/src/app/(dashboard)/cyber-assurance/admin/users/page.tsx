...
import { DataTable, IfPermission, SearchInput, PageLoader } from '@/cyber-assurance/components/ui';
import { BarChart3, Edit2, Plus, Trash2 } from 'lucide-react';
import { adminApi, AdminUser, AdminRole } from '@/cyber-assurance/lib/api';
      ...
      accessor: (user: AdminUser) => (
        <div className="flex items-center gap-1">
          <IfPermission required="admin:users:view">
            <Link
              href={`/cyber-assurance/admin/users/${user.id}/usage`}
