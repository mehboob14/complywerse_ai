...
import { onboardingApi } from '@/cyber-assurance/lib/api';
                ...
                return (
                  <button
                    onClick={() => {
                      ...
                      sessionStorage.setItem('ava.bulkEnroll.prefill', JSON.stringify({
                        hostnames,
                        mode: runnerType === 'windows_winrm' ? 'endpoint' : 'collector',
                        os_family: runnerType === 'windows_winrm' ? 'windows' : 'linux',
                      }));
                      router.push('/cyber-assurance/admin/agents?bulkEnroll=1');
                    }}
