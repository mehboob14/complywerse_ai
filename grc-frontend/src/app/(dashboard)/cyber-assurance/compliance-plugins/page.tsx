...
import { compliancePluginsApi, assetsApi, integrationsApi, apiClient } from '@/cyber-assurance/lib/api';
              ...
              {plugins.slice(0, 60).map((p) => (
                ...
                >
                  <div className="p-3">
                    ...
                    <Link
                      href={`/cyber-assurance/compliance-plugins#plugin-${p.id}`}
