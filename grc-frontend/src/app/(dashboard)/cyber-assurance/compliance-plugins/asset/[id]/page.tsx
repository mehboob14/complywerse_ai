...
export default function ComplianceAssetDashboardPage() {
  ...
  if (q.isError || !q.data) {
    return (
      <div className="p-6">
        <Link href="/cyber-assurance/compliance-plugins" className="text-sm text-blue-600 hover:underline">
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <Link
          href="/cyber-assurance/compliance-plugins"
        ...
        <button
          ...
          disabled={scanMut.isPending || progress !== null}
              ...
              {paged.map((r) => (
                <tr key={r.plugin_id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 text-right">
                    {r.run_id ? (
                      <Link
                        href={`/cyber-assurance/compliance-plugins#plugin-${r.plugin_id}`}
