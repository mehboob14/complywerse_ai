...
export const rcsaApi = {
  getTemplates: () => apiClient.get('/grc/erm/rcsa/templates'),
  getTemplate: (id: number) => apiClient.get(`/grc/erm/rcsa/templates/${id}`),
  createTemplate: (data: Record<string, unknown>) => apiClient.post('/grc/erm/rcsa/templates', data),
  updateTemplate: (id: number, data: Record<string, unknown>) => apiClient.put(`/grc/erm/rcsa/templates/${id}`, data),
  deleteTemplate: (id: number) => apiClient.delete(`/grc/erm/rcsa/templates/${id}`),
  cloneTemplate: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/templates/${id}/clone`, data),
  uploadTemplate: (formData: FormData) => apiClient.post('/grc/erm/rcsa/templates/upload', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  downloadTemplate: (id: number) => apiClient.get(`/grc/erm/rcsa/templates/download/${id}`, { responseType: 'blob' }),
  
  getCampaigns: (params?: { status?: string; period?: string }) => apiClient.get('/grc/erm/rcsa/campaigns', { params }),
  getCampaign: (id: number) => apiClient.get(`/grc/erm/rcsa/campaigns/${id}`),
  createCampaign: (data: Record<string, unknown>) => apiClient.post('/grc/erm/rcsa/campaigns', data),
  updateCampaign: (id: number, data: Record<string, unknown>) => apiClient.put(`/grc/erm/rcsa/campaigns/${id}`, data),
  deleteCampaign: (id: number) => apiClient.delete(`/grc/erm/rcsa/campaigns/${id}`),
  activateCampaign: (id: number) => apiClient.post(`/grc/erm/rcsa/campaigns/${id}/activate`),
  closeCampaign: (id: number) => apiClient.post(`/grc/erm/rcsa/campaigns/${id}/close`),
  assignBusinessUnits: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/campaigns/${id}/assign`, data),
  sendReminders: (id: number) => apiClient.post(`/grc/erm/rcsa/campaigns/${id}/reminders`),
  exportResults: (id: number) => apiClient.get(`/grc/erm/rcsa/campaigns/${id}/export`, { responseType: 'blob' }),
  
  getDashboardSummary: () => apiClient.get('/grc/erm/rcsa/dashboard/summary'),
  getFindingsBySeverity: () => apiClient.get('/grc/erm/rcsa/dashboard/findings-by-severity'),
  getBUProgress: () => apiClient.get('/grc/erm/rcsa/dashboard/business-unit-progress'),
  getRecentCampaigns: () => apiClient.get('/grc/erm/rcsa/dashboard/recent-campaigns'),

  getAssessments: (params?: Record<string, unknown>) => apiClient.get('/grc/erm/rcsa/assessments', { params }),
  getAssessment: (id: number) => apiClient.get(`/grc/erm/rcsa/assessments/${id}`),
  startAssessment: (id: number) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/start`),
  saveResponses: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/save`, data),
  submitAssessment: (id: number) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/submit`),
  getAISuggestions: (id: number) => apiClient.get(`/grc/erm/rcsa/assessments/${id}/ai-suggestions`),

  approveAssessment: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/approve`, data),
  rejectAssessment: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/reject`, data),
  returnAssessment: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/return`, data),
  delegateAssessment: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/assessments/${id}/delegate`, data),
  getPendingApprovals: (params?: Record<string, unknown>) => apiClient.get('/grc/erm/rcsa/assessments/pending-approvals', { params }),

  getFindings: (params?: Record<string, unknown>) => apiClient.get('/grc/erm/rcsa/findings', { params }),
  getFinding: (id: number) => apiClient.get(`/grc/erm/rcsa/findings/${id}`),
  createFinding: (data: Record<string, unknown>) => apiClient.post('/grc/erm/rcsa/findings', data),
  updateFinding: (id: number, data: Record<string, unknown>) => apiClient.put(`/grc/erm/rcsa/findings/${id}`, data),
  linkFindingToRisk: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/findings/${id}/link-risk`, data),
  linkFindingToControl: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/findings/${id}/link-control`, data),
  createFindingAction: (id: number, data: Record<string, unknown>) => apiClient.post(`/grc/erm/rcsa/findings/${id}/create-action`, data),

  getApprovalWorkflows: () => apiClient.get('/grc/erm/rcsa/approval-workflows'),
  createApprovalWorkflow: (data: Record<string, unknown>) => apiClient.post('/grc/erm/rcsa/approval-workflows', data),
  updateApprovalWorkflow: (id: number, data: Record<string, unknown>) => apiClient.put(`/grc/erm/rcsa/approval-workflows/${id}`, data),
};
