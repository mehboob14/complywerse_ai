...
SOC2_QUANTITATIVE_LIBRARY: List[Dict[str, Any]] = [
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.1",
        "title": "AWS — No root user access keys",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.2",
        "title": "AWS — IAM password policy minimum length ≥ 14",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.3",
        "title": "AWS — IAM users can be inventoried",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.6",
        "title": "AWS — S3 account Block Public Access (ACLs)",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.7",
        "title": "AWS — EBS encryption by default",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC6.8",
        "title": "AWS — Review default security groups (SSH surface)",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC7.1",
        "title": "AWS — Security Hub hub available",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC7.2",
        "title": "AWS — CloudTrail trail present",
    ...
    },
    {
        ...
        "benchmark": BENCHMARK,
        "rule_id": "CC7.3",
        "title": "AWS — GuardDuty detector present",
