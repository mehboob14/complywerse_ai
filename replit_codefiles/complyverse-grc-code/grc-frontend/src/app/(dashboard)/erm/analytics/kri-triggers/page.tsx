    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Automated KRI Triggers</h1>
            <p className="text-sm text-slate-400">Real-time alerts for Key Risk Indicator threshold breaches</p>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
          <div className="rounded-xl border border-slate-700 bg-slate-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-slate-400">Total KRIs Monitored</p>
                <p className="text-2xl font-bold text-white">{summary.total_kris_monitored}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-700 bg-slate-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-slate-400">KRIs In Breach</p>
          ...
          <div className="rounded-xl border border-slate-700 bg-slate-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-slate-400">KRIs Healthy</p>
      ...
      <div className="flex items-center gap-4 rounded-xl border border-slate-700 bg-slate-800 px-4 py-3">
        ...
        <select
          ...
          className="rounded-lg border border-slate-600 bg-slate-700 px-3 py-1.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
        >
      ...
      {alerts.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 rounded-xl border border-slate-700 bg-slate-800">
          <div className="rounded-full bg-green-500/20 p-4">
            <CheckCircle className="h-12 w-12 text-green-400" />
          </div>
          <h3 className="mt-4 text-lg font-semibold text-white">All KRIs are within acceptable thresholds</h3>
          <p className="mt-1 text-slate-400">No alerts to display. All monitored indicators are healthy.</p>
        </div>
      ) : (
        <div className="space-y-6">
...
function AlertCard({ alert }: { alert: KRIAlert }) {
  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-800 p-5 space-y-4">
      ...
      <div>
        <h3 className="text-lg font-semibold text-white">{alert.kri_name}</h3>
        <div className="mt-1 flex items-center gap-2">
          <Zap className="h-3.5 w-3.5 text-slate-500" />
          <span className="text-sm text-slate-400">{alert.risk_title}</span>
        </div>
      </div>

      <div className="rounded-lg bg-slate-900/50 p-3 space-y-2">
        <div className="flex items-center gap-2 text-sm">
          <span className="font-medium text-white">Current: {alert.current_value.toFixed(1)}</span>
