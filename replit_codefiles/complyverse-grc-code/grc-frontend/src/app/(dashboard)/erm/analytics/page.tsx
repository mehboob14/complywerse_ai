      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {analyticsModules.map((module) => (
          <Link
            key={module.href}
            href={module.href}
            className="group bg-slate-800 border border-slate-700 rounded-xl p-6 hover:border-slate-600 transition-all hover:shadow-lg hover:shadow-blue-500/5"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {analyticsModules.map((module) => (
            <Link
              key={module.href}
              href={module.href}
              className="flex items-center gap-2 px-3 py-2 bg-slate-700/30 rounded-lg hover:bg-slate-700/60 transition-colors text-sm text-slate-300 hover:text-white"
            >
