...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 10px -3px rgba(28, 43, 58, 0.2)',
        'glow': '0 0 20px -5px rgba(28, 43, 58, 0.3)',
        'glow-lg': '0 0 30px -5px rgba(28, 43, 58, 0.4)',
        'inner-glow': 'inset 0 0 20px -10px rgba(28, 43, 58, 0.2)',
