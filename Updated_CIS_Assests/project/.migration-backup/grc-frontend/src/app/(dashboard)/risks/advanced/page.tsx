    ...
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{dashboard?.total_incidents || 0}</p>
        ...
        <div className="rounded-lg bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{dashboard?.open_incidents || 0}</p>
        ...
        <div className="rounded-lg bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{dashboard?.avg_resolution_time_days || 0}d</p>
      ...
      {incidents && incidents.length > 0 ? (
          ...
          <table className="w-full">
            ...
            <tbody>
              {incidents.map((incident) => {
                ...
                return (
                  <tr key={incident.id} className="border-b border-slate-200/50 hover:bg-slate-100/30">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-slate-900">No incidents logged</h3>
...
function ReviewCard({ review }: { review: RiskReview }) {
  ...
  return (
    <div className={`rounded-lg border p-4 ${isOverdue ? 'border-red-500/50 bg-red-500/5' : 'border-slate-200 bg-white'}`}>
      <div className="flex items-start justify-between">
        <div>
      ...
      {dependencies && dependencies.length > 0 ? (
        <div className="space-y-3">
          {dependencies.map((dep) => {
            ...
            return (
              <div key={dep.id} className="flex items-center justify-between rounded-lg border border-slate-200 bg-white p-4">
                <div className="flex items-center gap-4">
                  <div className="text-right">
