...
router.include_router(policy_exceptions_router, tags=["Policy Exceptions"])
router.include_router(critical_rules_router, tags=["Policy AI Critical Rules"])
router.include_router(patch_proposals_router, tags=["Policy AI Patch Proposals"])
router.include_router(clause_coverage_router, tags=["Policy AI Clause Coverage"])
router.include_router(email_approvals_router, tags=["Policy AI Email Approvals"])
