...
export default function GovernanceDashboardPage() {
  ...
  const createdTotal = trendData.reduce((sum: number, item: { created: number; published: number }) => sum + item.created, 0);
  const publishedTotalInPeriod = trendData.reduce((sum: number, item: { created: number; published: number }) => sum + item.published, 0);
