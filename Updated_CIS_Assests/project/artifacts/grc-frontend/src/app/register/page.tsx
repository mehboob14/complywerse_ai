  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Fresh signup → straight to the dashboard. The Connect Wizard
        // lives under Admin → Integrations and is opened explicitly when
        // the tenant admin is ready to onboard a host (per UX feedback —
        // first-time signup should land in the platform, not in a forced
        // wizard).
